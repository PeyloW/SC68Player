...
-(void)displayVisualQueForMovingView:(UIView*)fromView fromRect:(CGRect)fromRect toRect:(CGRect)toRect;
{
  ...
  [fromView.window addSubview:imageView];
...
-(void)animationDidStop:(NSString*)animationID finished:(NSNumber*)finished context:(void*)context;
{
    ...
    [[UIApplication sharedApplication] endIgnoringInteractionEvents];
		UIImageView* flashView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"flash.png"]];
    ...
    [[UIApplication sharedApplication] endIgnoringInteractionEvents];
  	...
  	[super animationDidStop:animationID finished:finished context:context];
  }
}
